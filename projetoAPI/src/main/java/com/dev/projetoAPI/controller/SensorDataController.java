...
public class SensorDataController {
	...
	@PostMapping(value = "/DataStream/{key}/SensorData", produces="application/json")
	public ResponseEntity<SensorDataDto> collect(@PathVariable String key, @RequestBody SensorDataForm form, UriComponentsBuilder uriBuilder) {
